...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE `visitor` SET `name`='".$name."',`relation`= '".$relation."',`v_date`= '".$v_date."',`visiting_time`= '".$visiting_time."', WHERE `lfno` = $lfno";
  ...
  <div class="header">
    ...
    <body>
        ...
        <form action="visitorupdate.php" method="post">
            ...
            Visiting Date:          <input type="date" name="v_date" required><br><br>
